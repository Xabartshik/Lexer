...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CHAR_T = 4,                     /* CHAR_T  */
  YYSYMBOL_CHAR_F = 5,                     /* CHAR_F  */
  YYSYMBOL_KW_OR = 6,                      /* KW_OR  */
  YYSYMBOL_KW_XOR = 7,                     /* KW_XOR  */
  YYSYMBOL_KW_AND = 8,                     /* KW_AND  */
  YYSYMBOL_KW_NOT = 9,                     /* KW_NOT  */
...
{
       0,   152,   152,   160,   164,   174,   182,   184,   186,   192,
     194,   200,   202,   208,   210,   212,   214
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "IDENT", "CHAR_T",
  "CHAR_F", "KW_OR", "KW_XOR", "KW_AND", "KW_NOT", "ASSIGN", "LPAREN",
  "RPAREN", "SEMICOLON", "$accept", "program", "statement_list",
  "statement", "expr", "term", "factor", "primary", YY_NULLPTR
};
...
{
       1,     0,     8,     1,   -12,    -2,   -12,   -12,   -12,   -12,
     -12,    -2,    -2,    -1,     9,   -12,   -12,   -12,     7,    -2,
      -2,   -12,    -2,   -12,     9,     9,   -12
};
...
{
       0,     0,     0,     2,     3,     0,     1,     4,    15,    13,
      14,     0,     0,     0,     6,     9,    12,    11,     0,     0,
       0,     5,     0,    16,     7,     8,    10
};
...
{
      17,     8,     9,    10,     1,    19,    20,    11,     6,    12,
       5,    26,    21,    19,    20,    24,    25,    22,     7,    23,
       0,     0,    18
};

static const yytype_int8 yycheck[] =
{
      11,     3,     4,     5,     3,     6,     7,     9,     0,    11,
      10,    22,    13,     6,     7,    19,    20,     8,     3,    12,
      -1,    -1,    12
};
...
#line 153 "parser.y"
        {
            (yyval.node) = make_node(NODE_PROGRAM, (yyvsp[0].node), NULL, NULL);
            root_ast = (yyval.node);
        }
...
#line 1235 "parser.tab.c"
  ...
  case 5: /* statement: IDENT ASSIGN expr SEMICOLON  */
#line 175 "parser.y"
        {
            (yyval.node) = make_binary(NODE_ASSIGN, (yyvsp[-3].node), (yyvsp[-1].node));
        }
...
#line 1249 "parser.tab.c"
  ...
  case 7: /* expr: expr KW_OR term  */
#line 185 "parser.y"
        { (yyval.node) = make_binary(NODE_OR,  (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1255 "parser.tab.c"
    break;

  case 8: /* expr: expr KW_XOR term  */
#line 187 "parser.y"
        { (yyval.node) = make_binary(NODE_XOR, (yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 1267 "parser.tab.c"
  ...
  case 10: /* term: term KW_AND factor  */
#line 195 "parser.y"
        { (yyval.node) = make_binary(NODE_AND, (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1273 "parser.tab.c"
    break;

  case 11: /* factor: KW_NOT factor  */
#line 201 "parser.y"
        { (yyval.node) = make_unary(NODE_NOT, (yyvsp[0].node)); }
#line 1279 "parser.tab.c"
    break;

  case 12: /* factor: primary  */
#line 203 "parser.y"
        { (yyval.node) = (yyvsp[0].node); }
#line 1285 "parser.tab.c"
    break;

  case 13: /* primary: CHAR_T  */
#line 209 "parser.y"
        { (yyval.node) = (yyvsp[0].node); }
#line 1291 "parser.tab.c"
    break;

  case 14: /* primary: CHAR_F  */
#line 211 "parser.y"
        { (yyval.node) = (yyvsp[0].node); }
#line 1297 "parser.tab.c"
    break;

  case 15: /* primary: IDENT  */
#line 213 "parser.y"
        { (yyval.node) = (yyvsp[0].node); }
#line 1303 "parser.tab.c"
    break;

  case 16: /* primary: LPAREN expr RPAREN  */
#line 215 "parser.y"
        { (yyval.node) = (yyvsp[-1].node); }
